...
\toprule
Corrector & \multicolumn{3}{c}{Rhodobacter} & \multicolumn{3}{c}{Mouse} \\
...
quorum & \winner{36} & \winner{21} & \winner{5.9} & \winner{89} & \winner{52} & \winner{12} \\
\bottomrule
\end{tabular}
...
%
%
\tabledesc{Error left and introduced}
...
quorum    & 31         & \winner{21.7}        & \winner{10.8}       & \winner{.0700} & \winner{2.33}            \\
\cmidrule{2-6}
...
quake     & 15         & \winner{7.81}        & 54.0                & \winner{.148} & \winner{4.22}            \\
quorum    & 6.5        & 29.4                 & \winner{34.7}       & .786          & 10.2                     \\
\bottomrule
\end{tabular}
...
%% TODO: number for coral worst than none seems bad. Check this number.

\bigskip

\begin{tabular}{@{}lS[detect-weight,table-format=3.1]S[detect-weight,table-format=2.1]S[detect-weight,table-format=1.2]S[detect-weight,table-format=2.1]@{}}
\toprule
Corrector & \multicolumn{2}{c}{Rhodobacter} & \multicolumn{2}{c}{Mouse} \\
\cmidrule(r){2-3} \cmidrule(l){4-5}
{}     & {Perfect (Mb)} & {\%}          & {Perfect (Gb)} & \%            \\
\midrule
none   & 42             & 32.0          & 2.01           & 54.5          \\
coral  & 118            & 85.6          & 3.37           & 89.8          \\
echo   & 114            & 75.0          &                &               \\
hitec  & 123            & 78.2          &                &               \\
quake  & 98.2           & 76.4          & 3.45           & \winner{98.3} \\
quorum & \winner{156}   & \winner{98.7} & \winner{3.62}  & 94.3          \\
\bottomrule
\end{tabular}
